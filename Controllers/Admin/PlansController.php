    ...
    public function create(Request $request): Response
    {
        ...
        $planId = Plan::create([
            ...
            'is_active' => isset($data['is_active'])
                ...
                : 1,
            'max_subscriptions' => isset($data['max_subscriptions'])
            ...
            'allocation_limit' => isset($data['allocation_limit'])
                && $data['allocation_limit'] !== null
                && $data['allocation_limit'] !== ''
                    ? (int) $data['allocation_limit']
                    : null,
            'startup_override' => isset($data['startup_override'])
                && $data['startup_override'] !== ''
                    ? trim($data['startup_override'])
                    : null,
            'image_override' => isset($data['image_override']) && $data['image_override'] !== ''
                    ? trim($data['image_override'])
                    : null,
            'card_background_image' => isset($data['card_background_image'])

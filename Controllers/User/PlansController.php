...
class PlansController
{
    ...
    public function validateCoupon(Request $request, int $planId): Response
    {
        $user = $request->get('user');
        $userId = (int) ($user['id'] ?? 0);
        ...
        $plan = $this->applyCustomResourcesToPlan(
            $plan,
        ...
        $initialCharge = (int) ($context['initial_charge_credits'] ?? $totalChargeCredits);
        $initialDiscount = (int) ($context['initial_discount_credits'] ?? 0);

        return ApiResponse::success(
            [
                'valid' => true,
                'coupon' => $context,
                'total_credits' => $totalChargeCredits,
                'charge_credits' => $initialCharge,
                'discount_credits' => $initialDiscount,
            ],
            'Coupon is valid',
            200,
        );
    ...
    public function subscribe(Request $request, int $planId): Response
    {
        ...
        Activity::createActivity([
            ...
            'context' => "User subscribed to plan: {$plan['name']} (ID: {$planId}). Subscription #$subscriptionId. Paid: " .
    ...
    private function applyCustomResourcesToPlan(
        array $plan,

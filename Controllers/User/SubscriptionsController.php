...
class SubscriptionsController
{
    ...
    public function list(Request $request): Response
    {
        ...
        foreach ($subscriptions as &$sub) {
            ...
            $sub['pending_cancellation'] = Subscription::isPendingCancellation(
                $sub,
            );
        }
        ...
        return ApiResponse::success(
            [
                ...
                'cancel_at_period_end' => SettingsHelper::getCancelAtPeriodEnd(),
            ],
    ...
    public function get(Request $request, int $subscriptionId): Response
    {
        ...
        $subscription['pending_cancellation'] = Subscription::isPendingCancellation(
            $subscription,
        );
    ...
    public function cancel(Request $request, int $subscriptionId): Response
    {
        ...
        if (!Subscription::cancel($subscriptionId, $userId, $atPeriodEnd)) {
            return ApiResponse::error(
        ...
        if (
            !$atPeriodEnd
            && $serverUuid
            && SettingsHelper::getSuspendServers()
        ) {
            try {
        ...
        Activity::createActivity([
            ...
            'context' => "User cancelled subscription #$subscriptionId (plan: {$subscription['plan_name']})" .
                ($atPeriodEnd
